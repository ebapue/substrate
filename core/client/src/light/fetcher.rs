...
use runtime_primitives::traits::{Block as BlockT, Header as HeaderT, Hash, HashFor, NumberFor,
	SimpleArithmetic, SaturatedConversion, CheckedConversion};
...
{
	fn build_anchor(&self, hash: H::Out) -> Result<state_machine::ChangesTrieAnchorBlockId<H::Out, Number>, String> {
		unimplemented!("TODO")
	}

	fn root(&self, _anchor: &ChangesTrieAnchorBlockId<H::Out, Number>, block: Number) -> Result<Option<H::Out>, String> {
